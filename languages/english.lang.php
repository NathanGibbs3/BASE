...
DEFINE('_MONTH','Month');
DEFINE('_YEAR','Year');
DEFINE('_ALERTGROUP',$UI_CW_Alert.' Group');
DEFINE('_ALERTTIME',$UI_CW_Alert.' Time');
...
DEFINE('_AGMAINT',$UI_CW_Alert.' Group Maintenance');
DEFINE('_USERPREF','User Preferences');
DEFINE('_CACHE','Cache & Status');
DEFINE('_ADMIN','Administration');
DEFINE('_GALERTD','Graph '.$UI_CW_Alert.' Data');
DEFINE('_GALERTDT','Graph '.$UI_CW_Alert.' Detection Time');
...
DEFINE('_USEALERTDB','Use '.$UI_CW_Alert.' Database');
...
DEFINE('_ERRDELALERT','Error Deleting '.$UI_CW_Alert);
...
DEFINE('_ALERTSCACHE',' alert(s) to the '.$UI_CW_Alert.' cache');
...
DEFINE('_DISPANYAG','{ any '.$UI_CW_Alert.' Group }');
...
DEFINE('_CHRTALERTOCCUR',$UI_CW_Alert.' Occurrences');
...
DEFINE('_GRAPHALERTDATA','Graph '.$UI_CW_Alert.' Data');
...
DEFINE('_MNTDBALERTNAME',$UI_CW_Alert.' DB '.$UI_CW_Name.':');
...
DEFINE('_SCSENSORTOTAL',$UI_CW_Sensor.'s/'.$UI_CW_Total.':');
...
DEFINE('_PSTOTALHOSTS',$UI_CW_Total.' Hosts Scanned');
...
DEFINE('_PROFILEALERT','Profile '.$UI_CW_Alert);
