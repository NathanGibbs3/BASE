...
DEFINE('_ROLEEXIST',"$UI_CW_Role giÃ  esistente");
// TD Migration Hack
if ($UI_Spacing == 1){
	$glue = ' ';
}else{
...
DEFINE('_ROLEIDEXIST',implode($glue, $UI_AD_RID)." giÃ  esistente");
...
DEFINE('_PHPERRORCSESSIONCODE','ERRORE PHP: un gestore sessione utente è giÃ  configurato, ma il codice handle specificato in <CODE>user_session_path</CODE> non è valido.');
DEFINE('_PHPERRORCSESSIONVAR','ERRORE PHP: un gestore sessione utente è giÃ  configurato, ma la sua implementazione non è specificata in BASE. Se si vuole utilizzare un gestore di sessioni utente, impostare <CODE>user_session_path</CODE> in <CODE>base_conf.php</CODE>.');
...
DEFINE('_BSTERRTIMETYPE','<FONT><B>il '.$UI_CW_Type.' di parametro che verrÃ  passato non è specificato!</B>  Scegliere "il" per specificare una singola data, o "tra" per un intervallo.</FONT>');
