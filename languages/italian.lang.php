...
DEFINE('_BSTERRTIMETYPE','<FONT><B>il tipo di parametro che verrÃ  passato non è specificato!</B>  Scegliere "il" per specificare una singola data, o "tra" per un intervallo.</FONT>');
