...
DEFINE('_NOVEMBER','Kas√Ωm');
DEFINE('_DECEMBER','Aral√Ωk');
DEFINE('_LAST','Son');
DEFINE('_FIRST','›lk');
...
DEFINE('_LASTALERTS','Son Uyar√Ωlar');
DEFINE('_LASTPORTS','Son Portlar');
DEFINE('_LASTTCP','Son TCP Uyar√Ωlar√Ω');
DEFINE('_LASTUDP','Son UDP Uyar√Ωlar√Ω');
DEFINE('_LASTICMP','Son ICMP Uyar√Ωlar√Ω');
...
DEFINE('_DISPLAYU','Kullan√Ωc√Ω G√∂r¸nt¸le');
...
DEFINE('_LOGINERROR','Kullan√Ωc√Ω geÁerli deil ya da '.strtolower($UI_CW_Pw).'n√Ωz yanl√Ω√æ!<br>L¸tfen tekrar deneyin');
...
DEFINE('_TALERTS','Bug¸n\'¸n uyar√Ωlar√Ω: ');
DEFINE('_SOURCEIP','Kaynak IP');
DEFINE('_DESTIP','Var√Ω√æ IP');
DEFINE('_L24ALERTS','Son 24 Saatin uyar√Ωlar√Ω: ');
DEFINE('_L72ALERTS','Son 72 Saatin uyar√Ωlar√Ω: ');
DEFINE('_UNIALERTS',' Benzersiz Uyar√Ωlar');
DEFINE('_LSOURCEPORTS','Son Kaynak Portlar√Ω: ');
DEFINE('_LDESTPORTS','Son Var√Ω√æ Portlar√Ω: ');
...
DEFINE('_UPDATEUSER','Kullan√Ωc√Ωy√Ω G¸ncelle');

//admin/index.php
DEFINE('_BASEADMIN','BASE Y√∂netimi');
DEFINE('_BASEADMINTEXT','L¸tfen soldan bir seÁenek seÁiniz.');
...
DEFINE('_EMAILALERTSFULL','Uyar√Ω(lar√Ω) Email\'e g√∂nder (t¸m)');
...
DEFINE('_ERRCACHENULL','÷nbellee Alma HATASI: NULL olay s√Ωras√Ω bulundu?');
...
DEFINE('_ERRSQLDBALLOAD1','<P><B>DB soyutlama kitapl√Ω√Ω y¸kleme hatas√Ω: </B> from ');
DEFINE('_ERRSQLDBALLOAD2','<P><CODE>base_conf.php</CODE> dosyas√Ωndaki <CODE>$DBlib_path</CODE> DB soyutlama kitapl√Ω√Ω dei√ækenini kontrol edin 
            <P>
            Y¸r¸rl¸kte kullan√Ωlan temel veritaban√Ω kitapl√Ω√Ω ADODB\'dir ten indirilebilir
            ');
DEFINE('_ERRSQLDBTYPE','GeÁersiz Veritaban√Ω Tipi Belirlenmi√æ');
DEFINE('_ERRSQLDBTYPEINFO1','<CODE>base_conf.php</CODE> dosyas√Ωndaki <CODE>\$DBtype</CODE> dei√ækeni tan√Ωmlanmam√Ω√æ veritaban√Ω tipinde ayarlanm√Ω√æ ');
...
DEFINE('_NODENCODED','(veri d√∂n¸√æt¸rme yok, DB yerel √æifrelemedeki √∂lÁ¸t san√Ωl√Ωyor)');
...
DEFINE('_SIGCLASS','›mza S√Ωn√Ωfland√Ωrma');
...
DEFINE('_INPUTCRTENC','Girdi ÷lÁ¸t¸ ﬁifreleme Tipi');
DEFINE('_CONVERT2WS','D√∂n¸√æt¸r (ararken)');

//base_state_common.inc.php
DEFINE('_PHPERRORCSESSION','PHP HATASI: ÷zel (kullan√Ωc√Ω) bir PHP oturumu saptand√Ω. Ancak, BASE aÁ√ΩkÁa bu √∂zel i√æleyiciyi kullanmak ¸zere ayarlanmam√Ω√æ. <CODE>base_conf.php</CODE> dosyas√Ωnda <CODE>use_user_session=1</CODE> olarak ayarlay√Ωn');
DEFINE('_PHPERRORCSESSIONCODE','PHP HATASI: ÷zel (kullan√Ωc√Ω) bir PHP oturum i√æleyicisi yap√Ωland√Ωr√Ωlm√Ω√æ, fakat <CODE>user_session_path</CODE> \'teki belirlenmi√æ i√æleyici kodu geÁersiz.');
DEFINE('_PHPERRORCSESSIONVAR','PHP HATASI: ÷zel (kullan√Ωc√Ω) bir PHP oturum i√æleyicisi yap√Ωland√Ωr√Ωlm√Ω√æ, fakat bu i√æleyicinin gerÁekle√ætirilmesi BASE\'de belirlenmemi√æ. Eer √∂zel bir oturum i√æleyici isteniyorsa, <CODE>base_conf.php</CODE> dosyas√Ωndaki <CODE>user_session_path</CODE> dei√ækenini ayarlay√Ωn.');
DEFINE('_PHPSESSREG','Oturum Kaydedildi');

//base_state_criteria.inc.php
DEFINE('_REMOVE','Kald√Ωr√Ωl√Ωyor');
DEFINE('_FROMCRIT','√∂lÁ¸tten');
DEFINE('_ERRCRITELEM','GeÁersiz √∂lÁ¸t √∂esi');

//base_state_query.inc.php
DEFINE('_VALIDCANNED','GeÁerli Konservelenmi√æ Sorgu Listesi');
DEFINE('_DISPLAYING','G√∂r¸nt¸leniyor');
DEFINE('_DISPLAYINGTOTAL','%d-%d uyar√Ωlar√Ω g√∂r¸nt¸leniyor, %d toplamda');
...
DEFINE('_ERRAGUPDATE','UG g¸ncelleme Hatas√Ω');
DEFINE('_ERRAGPACKETLIST','UG iÁin paket listesi silme Hatas√Ω:');
DEFINE('_ERRAGDELETE','UG silme Hatas√Ω');
DEFINE('_AGDELETE','Ba√æar√Ωl√Ω biÁimde S›L›ND›');
DEFINE('_AGDELETEINFO','bilgi silindi');
DEFINE('_ERRAGSEARCHINV','Girilen arama √∂lÁ¸t¸ geÁersiz.  Tekrar deneyin!');
DEFINE('_ERRAGSEARCHNOTFOUND','Bu √∂lÁ¸te g√∂re UG bulunamad√Ω.');
DEFINE('_NOALERTGOUPS','HiÁ Uyar√Ω Grubu yok');
DEFINE('_NUMALERTS','# Uyar√Ωlar');
DEFINE('_ACTIONS','Eylemler');
DEFINE('_NOTASSIGN','hen¸z atanmam√Ω√æ');
...
DEFINE('_ERRSNORTVER','Eski bir s¸r¸m olabilir.  Sadece Snort 1.7-beta0 ve sonraki s¸r¸mler taraf√Ωndan yarat√Ωlan uyar√Ω veritabanlar√Ω desteklenmektedir');
DEFINE('_ERRSNORTVER1','temel veritaban√Ω');
DEFINE('_ERRSNORTVER2','eksik/geÁersiz g√∂r¸nmektedir');
DEFINE('_ERRDBSTRUCT1','veritaban√Ω s¸r¸m¸ geÁerli, fakat BASE DB yap√Ωs√Ω');
...
DEFINE('_ERRPHPERROR2',' PHP\'nin Áok eski.  L¸tfen 4.0.4 veya sonraki bir s¸r¸me y¸kseltin');
DEFINE('_ERRPHPMYSQLSUP','<B>PHP in√æas√Ω eksik</B>: <FONT>uyar√Ω veritaban√Ωn√Ω okumak iÁin gerekli 
               ...
               L¸tfen gerekli kitapl√Ωk ile birlikte PHP\'yi yeniden derleyin (<CODE>--with-mysql</CODE>)</FONT>');
DEFINE('_ERRPHPPOSTGRESSUP','<B>PHP in√æas√Ω eksik</B>: <FONT>uyar√Ω veritaban√Ωn√Ω okumak iÁin gerekli 
               ...
               L¸tfen gerekli kitapl√Ωk ile birlikte PHP\'yi yeniden derleyin (<CODE>--with-pgsql</CODE>)</FONT>');
DEFINE('_ERRPHPMSSQLSUP','<B>PHP in√æas√Ω eksik</B>: <FONT>uyar√Ω veritaban√Ωn√Ω okumak iÁin gerekli 
                   ...
                   L¸tfen gerekli kitapl√Ωk ile birlikte PHP\'yi yeniden derleyin (<CODE>--enable-mssql</CODE>)</FONT>');
DEFINE('_ERRPHPORACLESUP','<B>PHP in√æas√Ω eksik</B>: <FONT>uyar√Ω veritaban√Ωn√Ω okumak iÁin gerekli 
                   ...
                   L¸tfen gerekli kitapl√Ωk ile birlikte PHP\'yi yeniden derleyin (<CODE>--with-oci8</CODE>)</FONT>');
...
DEFINE('_PLOTMARGINS','«izim Bo√æluklar√Ω: (sol x sa x ¸st x alt)');
...
DEFINE('_CHRTTYPEDAY','Zaman (g¸n) vs. Uyar√Ω Say√Ωs√Ω');
...
DEFINE('_CHRTTYPESIG','›mza S√Ωn√Ωflamas√Ω vs. Uyar√Ω Say√Ωs√Ω');
...
DEFINE('_CHRTMINTRESH','En D¸√æ¸k E√æik Deeri');
...
DEFINE('_ERRCHRTNOTYPE','HiÁbir grafik tipi belirtilmemi√æ');
DEFINE('_ERRNOAGSPEC','HiÁbir UG belirtilmemi√æ.  T¸m uyar√Ωlar√Ω kullan√Ωyor.');
...
DEFINE('_CHRTSIGNUMBER','›mza S√Ωn√Ωflamas√Ω vs. Uyar√Ω Say√Ωs√Ω');
DEFINE('_CHRTCLASS','S√Ωn√Ωflama');
DEFINE('_CHRTSENSORNUMBER','Sensor vs. Uyar√Ω Say√Ωs√Ω');
DEFINE('_CHRTHANDLEPERIOD','›√æleme D√∂nemi, eer gerekliyse');
...
DEFINE('_MNTDBARCHNAME','ARﬁ›V DB Ad√Ω:');
DEFINE('_MNTAIC','Uyar√Ω Bilgi ÷nbellei:');
...
DEFINE('_MNTIPACDNSC','DNS ÷nbellee al√Ωnd√Ω:');
DEFINE('_MNTIPACWC','Whois ÷nbellee al√Ωnd√Ω:');
DEFINE('_MNTIPACUDIP','Benzersiz Var√Ω√æ IP:');

//base_qry_alert.php
DEFINE('_QAINVPAIR','GeÁersiz (sid,cid) Áift');
DEFINE('_QAALERTDELET','Uyar√Ω S›L›ND›');
DEFINE('_QATRIGGERSIG','Tetiklenmi√æ ›mza');
DEFINE('_QANORMALD','Normal G√∂r¸nt¸');
DEFINE('_QAPLAIND','D¸z G√∂r¸nt¸');
DEFINE('_QANOPAYLOAD','H√Ωzl√Ω g¸nl¸kleme kullan√Ωld√Ω bu y¸zden payload at√Ωld√Ω');
...
DEFINE('_QCDATA','Veri');
DEFINE('_QCERRCRITWARN','÷lÁ¸t uyar√Ωs√Ω:');
...
DEFINE('_QCERRSPECVALUE','onun bir √∂lÁ¸t olmas√Ω gerektiini g√∂stermek ¸zere seÁilmi√æ, fakat hangisiyle e√æle√æeceini g√∂steren hiÁbir deer belirlenmemi√æ.');
DEFINE('_QCERRBOOLEAN','Aralar√Ωnda bir boolen i√æleci olmadan (√∂rnein; VE, YA DA) «oklu Protokol Alan √∂lÁ¸t¸ girildi.');
DEFINE('_QCERRDATEVALUE','baz√Ω tarih/zaman √∂lÁ¸t¸n¸n e√æle√æmesi gerektiini g√∂stermek ¸zere seÁilmi√æ, fakat hiÁbir deer belirlenmemi√æ.');
DEFINE('_QCERRINVHOUR','(GeÁersiz Saat) Belirtilen zamana uygun hiÁbir tarih girilmemi√æ.');
DEFINE('_QCERRDATECRIT','baz√Ω tarih/zaman √∂lÁ¸t¸n¸n e√æle√æmesi gerektiini g√∂stermek ¸zere seÁilmi√æ, fakat hiÁbir deer belirlenmemi√æ.');
DEFINE('_QCERROPERSELECT','girilmi√æ fakat hiÁbir i√æletici seÁilmemi√æ.');
DEFINE('_QCERRDATEBOOL','Aralar√Ωnda bir boolen i√æleci olmadan (√∂rnein; VE, YA DA) «oklu Tarih/Zaman √∂lÁ¸t¸ girildi.');
DEFINE('_QCERRPAYCRITOPER','bir payload √∂lÁ¸t alan√Ω iÁin girilmi√æ, fakat bir i√æletici (√∂rnein; sahip, sahip deil) belirtilmemi√æ.');
DEFINE('_QCERRPAYCRITVALUE','payload\'√Ωn bir √∂lÁ¸t olmas√Ω gerektiini g√∂stermek ¸zere seÁilmi√æ, fakat hangisiyle e√æle√æeceini g√∂steren hiÁbir deer belirlenmemi√æ.');
DEFINE('_QCERRPAYBOOL','Aralar√Ωnda bir boolen i√æleci olmadan (√∂rnein; VE, YA DA) «oklu Veri payload √∂lÁ¸t¸ girildi.');
DEFINE('_QCMETACRIT','Meta ÷lÁ¸t¸');
DEFINE('_QCIPCRIT','IP ÷lÁ¸t¸');
DEFINE('_QCPAYCRIT','Payload ÷lÁ¸t¸');
DEFINE('_QCTCPCRIT','TCP ÷lÁ¸t¸');
DEFINE('_QCUDPCRIT','UDP ÷lÁ¸t¸');
DEFINE('_QCICMPCRIT','ICMP ÷lÁ¸t¸');
DEFINE('_QCLAYER4CRIT','4. Katman ÷lÁ¸t¸');
DEFINE('_QCERRINVIPCRIT','GeÁersiz IP adres √∂lÁ¸t¸');
DEFINE('_QCERRCRITADDRESSTYPE','bir √∂lÁ¸t deeri olmas√Ω iÁin girilmi√æ, fakat adresin tipi (√∂rnein; kaynak, var√Ω√æ) belirlenmemi√æ.');
DEFINE('_QCERRCRITIPADDRESSNONE','bir IP adresinin bir √∂lÁ¸t olmas√Ω gerektiini g√∂steriyor, fakat hangisiyle e√æle√æeceini g√∂steren hiÁbir adres belirlenmemi√æ.');
DEFINE('_QCERRCRITIPADDRESSNONE1','seÁilmi√æ (#');
DEFINE('_QCERRCRITIPIPBOOL','IP ÷lÁ¸t¸ aras√Ωnda bir boolen i√æleci olmadan (√∂rnein; VE, YA DA) «oklu IP adres √∂lÁ¸t¸ girildi');

//base_qry_form.php
DEFINE('_QFRMSORTORDER','S√Ωralama d¸zeni');
...
DEFINE('_SCTOTALNUMALERTS','Toplam Uyar√Ω Say√Ωs√Ω:');
...
DEFINE('_PSEVENTERROPENFILE','Portscan olay dosyas√Ωn√Ω aÁmak olanaks√Ωz');
...
DEFINE('_PSFIRSTOCC','›lk<BR> GerÁekle√æen Olay');
DEFINE('_PSLASTOCC','Son<BR> GerÁekle√æen Olay');
DEFINE('_PSUNIALERTS','Benzersiz Uyar√Ωlar');
DEFINE('_PSPORTSCANEVE','Portscan Olaylar√Ω');
DEFINE('_PSREGWHOIS','Kay√Ωt bak√Ω√æ√Ω (whois)');
DEFINE('_PSNODNS','hiÁ DNS Á√∂z¸n¸rl¸¸ denenmedi');
...
DEFINE('_PSALLALERTSAS','t¸m uyar√Ωlarla birlikte %s/%s olarak');
...
DEFINE('_BSTTIMECRIT','Zaman ÷lÁ¸t¸');
DEFINE('_BSTERRPROFILECRIT','<FONT><B>HiÁbir profilleme √∂lÁ¸t¸ belirlenmemei√æ!</B>  "saat", "g¸n", ya da "ay" ¸zerine t√Ωklayarak k¸melenmi√æ istatistiklerden taneli olan√Ω seÁin.</FONT>');
DEFINE('_BSTERRTIMETYPE','<FONT><B>GeÁecek olan zaman parametresi tipi belirlenmemei√æ!</B>  Tek bir zaman belirtmek iÁin "¸zerinde", ya da bir aral√Ωk belirtmek iÁin "aras√Ωnda" \'dan herhangi birini seÁin.</FONT>');
...
DEFINE('_BSTERRNODAY','<FONT><B>HiÁbir G¸n parametresi belirtilmemi√æ!</B></FONT>');
...
DEFINE('_SUAERRCRITADDUNK','÷L«‹T HATASI: bilinmeyen adres tipi -- Var√Ω√æ adresi olduu san√Ωl√Ωyor');
