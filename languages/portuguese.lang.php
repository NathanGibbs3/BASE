...
//base_footer.php
DEFINE('_FOOTER','( Por <A class="largemenuitem" href="https://github.com/secureideas">Kevin Johnson</A> e grupo <A class="largemenuitem" href="https://github.com/NathanGibbs3/BASE/wiki/Project-Team">do projeto BASE</A><BR>Baseado no ACID de Roman Danyliw )');
...
//base_action.inc.php
DEFINE('_NOACTION','Nenhuma ação foi especificada nos '.$UI_CW_Alert.'s');
DEFINE('_INVALIDACT',' é uma ação inválida');
DEFINE('_ERRNOAG','Não foi possível adicionar '.$UI_CW_Alert.'s porque o AG não foi especificado');
...
DEFINE('_DELETEALERT','Deletar '.$UI_CW_Alert.'(s)');
DEFINE('_EMAILALERTSFULL',$UI_CW_Alert.'(s) de E-mail (cheio)');
...
DEFINE('_NOALERTSSELECT','Nenhum '.$UI_CW_Alert.' foi selecionado ou o');
...
DEFINE('_ERRDELALERT','Erro apagando '.$UI_CW_Alert);
...
DEFINE('_ERRCACHEUPDATE','Não foi possível atualizar cache de '.$UI_CW_Event.'s');
DEFINE('_ALERTSCACHE',' '.$UI_CW_Alert.'(s) para o cache de '.$UI_CW_Alert.'s');
...
DEFINE('_ERRSQLCONNECTINFO','<P>Cheque as variáveis de conexão ao BD em <I>base_conf.php</I>
              <PRE>
               = $alert_dbname   : Banco de dados MySQL onde os '.$UI_CW_Alert.'s estão gravados 
...
DEFINE('_NOALERTS','Nenhum '.$UI_CW_Alert.' foi encontrado.');
...
DEFINE('_ERRPHPMYSQLSUP','<B>Compilação do PHP incompleta</B>: <FONT>o suporte ao MySQL necessário para
               ler o banco de dados de '.$UI_CW_Alert.'s não foi compilado no PHP.  
...
DEFINE('_ERRCHRTNOTYPE','Nenhum '.$UI_CW_Type.' de gráfico foi especificado');
DEFINE('_ERRNOAGSPEC','Nenhum AG foi especificado. Usando todos '.$UI_CW_Alert.'s.');
...
DEFINE('_MNTDBALERTNAME','Nome do BD de '.$UI_CW_Alert.':');
DEFINE('_MNTDBARCHNAME','Nome do BD de ARQUIVO:');
DEFINE('_MNTAIC','Informações do cache de '.$UI_CW_Alert.':');
DEFINE('_MNTAICTE',$UI_CW_Total.' de '.$UI_CW_Event.'s:');
DEFINE('_MNTAICCE',$UI_CW_Events.' no Cache:');
